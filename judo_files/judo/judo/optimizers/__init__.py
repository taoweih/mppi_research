...
from judo.optimizers.mppi_staged_rollout import MPPIStagedRollout, MPPIStagedRolloutConfig
...
_registered_optimizers: dict[str, tuple[Type[Optimizer], Type[OptimizerConfig]]] = {
    ...
    "mppi_staged_rollout":(MPPIStagedRollout,MPPIStagedRolloutConfig),
}
